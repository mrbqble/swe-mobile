	...
	auth: {
		...
		forgotPassword: {
			en: {
				...
				emailDescription: 'We will verify your email and allow you to reset your password.',
				enterNewPassword: 'Enter your new password',
				passwordDescription: 'Please enter a new password that meets the requirements below.',
				email: 'Email',
				emailPlaceholder: 'Enter your email',
				...
				emailCheckFailed: 'Failed to verify email',
				allFieldsRequired: 'All fields are required',
			...
			ru: {
				...
				emailDescription: 'Мы проверим вашу электронную почту и позволим вам сбросить пароль.',
				enterNewPassword: 'Введите ваш новый пароль',
				passwordDescription: 'Пожалуйста, введите новый пароль, соответствующий требованиям ниже.',
				email: 'Email',
	...
	consumer: {
		...
		cart: {
			en: {
				...
				confirmOrderMessage: 'Place order for {count} items?',
				product: 'Product',
				quantity: 'Qty',
				subtotal: 'Subtotal',
				item: 'item',
			...
			ru: {
				...
				confirmOrderMessage: 'Оформить заказ на {count} товаров?',
				product: 'Товар',
				quantity: 'Кол-во',
				subtotal: 'Подытог',
				item: 'товар',
		...
		orderDetail: {
			en: {
				...
				complaint: 'Complaint',
				complaintOpen: 'Open',
				complaintEscalated: 'Escalated',
				complaintResolved: 'Resolved',
				viewComplaintDetails: 'View Complaint Details',
				reorder: 'Reorder',
				reordering: 'Placing order...',
				reorderSuccess: 'Order placed successfully!',
			...
			ru: {
				...
				complaint: 'Жалоба',
				complaintOpen: 'Открыта',
				complaintEscalated: 'Эскалирована',
				complaintResolved: 'Решена',
				viewComplaintDetails: 'Просмотр деталей жалобы',
				reorder: 'Повторить заказ',
				reordering: 'Размещение заказа...',
				reorderSuccess: 'Заказ успешно размещен!',
				reorderFailed: 'Не удалось повторить заказ'
			}
		},
		productDetail: {
			en: {
		...
		profile: {
			en: {
				...
				organizationNote: 'Organization name cannot be changed after registration',
				email: 'Email',
				...
				permissionDenied: 'Permission to access camera roll is required',
				imagePickFailed: 'Failed to pick image',
				imageConversionFailed: 'Failed to process image',
				deactivateAccount: 'Deactivate Account',
				deactivateConfirm: 'Are you sure you want to deactivate your account? You can reactivate it by signing in again.',
			...
			ru: {
				...
				organizationPlaceholder: 'Введите название организации',
				organizationNote: 'Название организации нельзя изменить после регистрации',
				email: 'Эл. почта',
				emailPlaceholder: 'Введите email',
				...
				permissionDenied: 'Требуется разрешение на доступ к галерее',
				imagePickFailed: 'Не удалось выбрать изображение',
				imageConversionFailed: 'Не удалось обработать изображение',
				deactivateAccount: 'Деактивировать аккаунт',
				deactivateConfirm: 'Вы уверены, что хотите деактивировать свой аккаунт? Вы можете активировать его снова, войдя в систему.',
				deactivate: 'Деактивировать',
				cancel: 'Отмена',
				accountDeactivated: 'Аккаунт успешно деактивирован',
		...
		requestLink: {
			en: {
				...
				submitMultipleRequests: 'Submit {count} Requests',
				...
				multipleRequestsSubmitted: 'Link requests sent to {count} suppliers.',
				partialSuccess: 'Sent {successful} request(s), {failed} failed.',
			...
			ru: {
				...
				submitMultipleRequests: 'Отправить {count} запросов',
				submitting: 'Отправка...',
				loading: 'Загрузка...',
				...
				multipleRequestsSubmitted: 'Запросы на связь отправлены {count} поставщикам.',
				partialSuccess: 'Отправлено {successful} запрос(ов), {failed} не удалось.',
	...
	supplier: {
		...
		catalog: {
			en: {
				...
				noProductsDesc: 'No products available in catalog',
				inStock: 'In Stock',
				outOfStock: 'Out of Stock',
				currency: '₸',
				edit: 'Edit',
			...
			ru: {
				...
				noProductsDesc: 'В каталоге нет товаров',
				inStock: 'В наличии',
				outOfStock: 'Нет в наличии',
				currency: '₸',
				edit: 'Редактировать',
	...
	shared: {
		...
		chat: {
			en: {
				...
				noAcceptedLinkTitle: 'No Accepted Link',
				noAcceptedLinkMessage:
			...
			ru: {
				...
				noAcceptedLinkTitle: 'Нет принятой связи',
				noAcceptedLinkMessage:
					'Вам нужна принятая связь с этим поставщиком, прежде чем вы сможете общаться. Запросите связь у поставщика, чтобы начать обмен сообщениями.',
