...
export default function ConsumerHomeScreen({ language = 'en', navigateTo }: ConsumerHomeScreenProps) {
  const t = translations[language];

  const quickActions = [
    {
      id: 'request-link',
      icon: () => <Feather name="link" size={24} color="#2563eb" />, // icon as function
      title: t.requestLink,
    ...
    {
      id: 'catalog',
      icon: () => <MaterialIcons name="shopping-bag" size={24} color="#059669" />,
      title: t.viewCatalog,
    ...
    {
      id: 'consumer-orders',
      icon: () => <Ionicons name="cube-outline" size={24} color="#a21caf" />,
      title: t.myOrders,
  ...
  const bottomTabs = [
    { id: 'consumer-home', label: t.home, icon: () => <Feather name="home" size={22} /> },
    { id: 'linked-suppliers', label: t.suppliers, icon: () => <Feather name="link" size={22} /> },
    { id: 'catalog', label: t.catalog, icon: () => <MaterialIcons name="shopping-bag" size={22} /> },
    { id: 'consumer-orders', label: t.orders, icon: () => <Ionicons name="cube-outline" size={22} /> },
    { id: 'consumer-profile', label: t.profile, icon: () => <Feather name="user" size={22} /> },
  ];
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={["left", "right", "bottom", "top"]}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.searchButton} onPress={() => navigateTo && navigateTo('catalog')}>
